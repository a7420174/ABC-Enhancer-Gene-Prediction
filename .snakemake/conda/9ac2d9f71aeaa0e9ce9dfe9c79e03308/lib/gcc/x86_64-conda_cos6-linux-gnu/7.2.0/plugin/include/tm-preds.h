/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/opt/conda/conda-bld/compilers_linux-64_1520532893746/work/.build/src/gcc-7.2.0/gcc/config/i386/i386.md'.  */
...
{
  return c >= CONSTRAINT_r && c <= CONSTRAINT_Yh;
}
