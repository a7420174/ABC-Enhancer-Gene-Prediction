...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "sorted_nearest.src.k_nearest_ties",
        "sources": [
            "sorted_nearest/src/k_nearest_ties.pyx"
        ]
    },
    "module_name": "sorted_nearest.src.k_nearest_ties"
}
END: Cython Metadata */
...
#define __PYX_HAVE__sorted_nearest__src__k_nearest_ties
#define __PYX_HAVE_API__sorted_nearest__src__k_nearest_ties
/* Early includes */
#include <stdint.h>
#include "pythread.h"
#include <string.h>
...
/* Module declarations from 'sorted_nearest.src.k_nearest_ties' */
...
static PyObject *__pyx_f_14sorted_nearest_3src_14k_nearest_ties_get_all_ties(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_14sorted_nearest_3src_14k_nearest_ties_get_different_ties(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "sorted_nearest.src.k_nearest_ties"
extern int __pyx_module_is_main_sorted_nearest__src__k_nearest_ties;
int __pyx_module_is_main_sorted_nearest__src__k_nearest_ties = 0;

/* Implementation of 'sorted_nearest.src.k_nearest_ties' */
...
static PyObject *__pyx_pf_14sorted_nearest_3src_14k_nearest_ties_get_all_ties(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_lx, __Pyx_memviewslice __pyx_v_ids, __Pyx_memviewslice __pyx_v_dist, int __pyx_v_k); /* proto */
static PyObject *__pyx_pf_14sorted_nearest_3src_14k_nearest_ties_2get_different_ties(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_lx, __Pyx_memviewslice __pyx_v_ids, __Pyx_memviewslice __pyx_v_dist, int __pyx_v_k); /* proto */
...
/* "sorted_nearest/src/k_nearest_ties.pyx":11
...
static PyObject *__pyx_pw_14sorted_nearest_3src_14k_nearest_ties_1get_all_ties(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_14sorted_nearest_3src_14k_nearest_ties_get_all_ties(__Pyx_memviewslice __pyx_v_lx, __Pyx_memviewslice __pyx_v_ids, __Pyx_memviewslice __pyx_v_dist, int __pyx_v_k, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_first_i;
  int __pyx_v_current_found;
  int __pyx_v_nfound;
  CYTHON_UNUSED int __pyx_v_current_id;
  int __pyx_v_last_id;
  int __pyx_v_length;
  CYTHON_UNUSED int __pyx_v_current_dist;
  int __pyx_v_last_dist;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("get_all_ties", 0);

  /* "sorted_nearest/src/k_nearest_ties.pyx":19
 ...
 */
  ...
  /* "sorted_nearest/src/k_nearest_ties.pyx":20
 *     cdef:
 *         int i = 0
 *         int first_i = 0             # <<<<<<<<<<<<<<
 *         int current_found = 0
 ...
 */
  ...
  /* "sorted_nearest/src/k_nearest_ties.pyx":21
 *         int i = 0
 *         int first_i = 0
 *         int current_found = 0             # <<<<<<<<<<<<<<
 *         int nfound = 0
 ...
 */
  __pyx_v_current_found = 0;

  /* "sorted_nearest/src/k_nearest_ties.pyx":22
 *         int first_i = 0
 *         int current_found = 0
 *         int nfound = 0             # <<<<<<<<<<<<<<
 *         int current_id = ids[0]
 ...
 */
  ...
  /* "sorted_nearest/src/k_nearest_ties.pyx":23
 *         int current_found = 0
 *         int nfound = 0
 *         int current_id = ids[0]             # <<<<<<<<<<<<<<
 *         int last_id = -1
 ...
 */
  __pyx_t_1 = 0;
  __pyx_v_current_id = (*((int64_t const  *) ( /* dim=0 */ ((char *) (((int64_t const  *) __pyx_v_ids.data) + __pyx_t_1)) )));

  /* "sorted_nearest/src/k_nearest_ties.pyx":24
 *         int nfound = 0
 *         int current_id = ids[0]
 *         int last_id = -1             # <<<<<<<<<<<<<<
 *         int length = len(lx)
 ...
 */
  ...
  /* "sorted_nearest/src/k_nearest_ties.pyx":25
 *         int current_id = ids[0]
 *         int last_id = -1
 *         int length = len(lx)             # <<<<<<<<<<<<<<
 *         int current_dist = -1
 *         int last_dist = -1
 */
  __pyx_t_2 = __Pyx_MemoryView_Len(__pyx_v_lx); 
  __pyx_v_length = __pyx_t_2;

  /* "sorted_nearest/src/k_nearest_ties.pyx":26
 *         int last_id = -1
 *         int length = len(lx)
 *         int current_dist = -1             # <<<<<<<<<<<<<<
 *         int last_dist = -1
 * 
 */
  __pyx_v_current_dist = -1;

  /* "sorted_nearest/src/k_nearest_ties.pyx":27
 *         int length = len(lx)
 *         int current_dist = -1
 *         int last_dist = -1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sorted_nearest/src/k_nearest_ties.pyx":29
 *         int last_dist = -1
 * 
 *     arr_lidx = np.ones(length, dtype=np.long) * -1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_ones); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_length); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_long); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_dtype, __pyx_t_7) < 0) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_7 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_5, __pyx_t_3); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyNumber_Multiply(__pyx_t_7, __pyx_int_neg_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_v_arr_lidx = __pyx_t_3;
  __pyx_t_3 = 0;

  /* "sorted_nearest/src/k_nearest_ties.pyx":33
 *     cdef long [::1] lidx
 * 
 *     lidx = arr_lidx             # <<<<<<<<<<<<<<
 * 
 *     while i < length:
 */
  __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_dc_long(__pyx_v_arr_lidx, PyBUF_WRITABLE); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 33, __pyx_L1_error)
  __pyx_v_lidx = __pyx_t_8;
  __pyx_t_8.memview = NULL;
  __pyx_t_8.data = NULL;

  /* "sorted_nearest/src/k_nearest_ties.pyx":35
 *     lidx = arr_lidx
 * 
 *     while i < length:             # <<<<<<<<<<<<<<
 * 
 ...
 */
  while (1) {
    ...
    /* "sorted_nearest/src/k_nearest_ties.pyx":44
 *         # print("nfound", nfound)
 *         # print("length", length)
 *         first_i = i             # <<<<<<<<<<<<<<
 * 
 *         if ids[i] != last_id:
 */
    __pyx_v_first_i = __pyx_v_i;

    /* "sorted_nearest/src/k_nearest_ties.pyx":46
 *         first_i = i
 * 
 *         if ids[i] != last_id:             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_t_1 = __pyx_v_i;
    __pyx_t_9 = (((*((int64_t const  *) ( /* dim=0 */ ((char *) (((int64_t const  *) __pyx_v_ids.data) + __pyx_t_1)) ))) != __pyx_v_last_id) != 0);
    if (__pyx_t_9) {

      /* "sorted_nearest/src/k_nearest_ties.pyx":51
 ...
 */
      ...
      /* "sorted_nearest/src/k_nearest_ties.pyx":52
 * 
 *             current_found = 0
 *             current_id = ids[i]             # <<<<<<<<<<<<<<
 *             last_id = ids[i]
 ...
 */
      ...
      /* "sorted_nearest/src/k_nearest_ties.pyx":53
 *             current_found = 0
 *             current_id = ids[i]
 *             last_id = ids[i]             # <<<<<<<<<<<<<<
 *             # continue
 ...
 */
      __pyx_t_1 = __pyx_v_i;
      __pyx_v_last_id = (*((int64_t const  *) ( /* dim=0 */ ((char *) (((int64_t const  *) __pyx_v_ids.data) + __pyx_t_1)) )));
 ...
 */
    ...
    /* "sorted_nearest/src/k_nearest_ties.pyx":57
 * 
 ...
 */
    while (1) {
      __pyx_t_10 = ((__pyx_v_i < __pyx_v_length) != 0);
      if (__pyx_t_10) {
      } else {
      ...
      __pyx_t_1 = __pyx_v_i;
      __pyx_t_10 = (((*((int64_t const  *) ( /* dim=0 */ ((char *) (((int64_t const  *) __pyx_v_ids.data) + __pyx_t_1)) ))) == __pyx_v_last_id) != 0);
      if (__pyx_t_10) {
      } else {
        __pyx_t_9 = __pyx_t_10;
        goto __pyx_L8_bool_binop_done;
      }
      __pyx_t_10 = ((__pyx_v_current_found < __pyx_v_k) != 0);
      __pyx_t_9 = __pyx_t_10;
      __pyx_L8_bool_binop_done:;
      if (!__pyx_t_9) break;

      /* "sorted_nearest/src/k_nearest_ties.pyx":60
 *             # print("**first while**")
 *             # print("i", i, "length", length, "ids[i]", ids[i], "last_id", last_id, "dist[i]", last_dist, "current_found", current_found)
 *             lidx[nfound] = lx[i]             # <<<<<<<<<<<<<<
 *             # print("lidx", arr_lidx)
 ...
 */
      ...
      *((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_lidx.data) + __pyx_t_11)) )) = (*((int64_t const  *) ( /* dim=0 */ ((char *) (((int64_t const  *) __pyx_v_lx.data) + __pyx_t_1)) )));

      /* "sorted_nearest/src/k_nearest_ties.pyx":62
 *             lidx[nfound] = lx[i]
 *             # print("lidx", arr_lidx)
 *             last_dist = dist[i]             # <<<<<<<<<<<<<<
 *             nfound += 1
 ...
 */
      __pyx_t_1 = __pyx_v_i;
      __pyx_v_last_dist = (*((int64_t const  *) ( /* dim=0 */ ((char *) (((int64_t const  *) __pyx_v_dist.data) + __pyx_t_1)) )));

      /* "sorted_nearest/src/k_nearest_ties.pyx":63
 *             # print("lidx", arr_lidx)
 *             last_dist = dist[i]
 *             nfound += 1             # <<<<<<<<<<<<<<
 *             current_found += 1
 ...
 */
      ...
      /* "sorted_nearest/src/k_nearest_ties.pyx":64
 *             last_dist = dist[i]
 *             nfound += 1
 *             current_found += 1             # <<<<<<<<<<<<<<
 *             i += 1
 * 
 */
      __pyx_v_current_found = (__pyx_v_current_found + 1);

      /* "sorted_nearest/src/k_nearest_ties.pyx":65
 *             nfound += 1
 *             current_found += 1
 *             i += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "sorted_nearest/src/k_nearest_ties.pyx":68
 * 
 *         # while we have not found all ties with same length as last included
 ...
 */
    while (1) {
      ...
      __pyx_t_1 = __pyx_v_i;
      __pyx_t_10 = (((*((int64_t const  *) ( /* dim=0 */ ((char *) (((int64_t const  *) __pyx_v_dist.data) + __pyx_t_1)) ))) == __pyx_v_last_dist) != 0);
      __pyx_t_9 = __pyx_t_10;
      __pyx_L13_bool_binop_done:;
      if (!__pyx_t_9) break;

      /* "sorted_nearest/src/k_nearest_ties.pyx":71
 *             # print("**second while**")
 *             # print("i", i, "length", length, "ids[i]", ids[i], "last_id", last_id, "dist[i]", last_dist, "current_found", current_found)
 *             lidx[nfound] = lx[i]             # <<<<<<<<<<<<<<
 *             # print("lidx", arr_lidx)
 ...
 */
      ...
      *((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_lidx.data) + __pyx_t_11)) )) = (*((int64_t const  *) ( /* dim=0 */ ((char *) (((int64_t const  *) __pyx_v_lx.data) + __pyx_t_1)) )));
      ...
      /* "sorted_nearest/src/k_nearest_ties.pyx":73
 *             lidx[nfound] = lx[i]
 *             # print("lidx", arr_lidx)
 *             nfound += 1             # <<<<<<<<<<<<<<
 *             i += 1
 ...
 */
      ...
      /* "sorted_nearest/src/k_nearest_ties.pyx":74
 *             # print("lidx", arr_lidx)
 *             nfound += 1
 *             i += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "sorted_nearest/src/k_nearest_ties.pyx":76
 *             i += 1
 * 
 *         if i == first_i:             # <<<<<<<<<<<<<<
 *             i += 1
 * 
 */
    __pyx_t_9 = ((__pyx_v_i == __pyx_v_first_i) != 0);
    if (__pyx_t_9) {

      /* "sorted_nearest/src/k_nearest_ties.pyx":77
 * 
 *         if i == first_i:
 *             i += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sorted_nearest/src/k_nearest_ties.pyx":81
 *         # print(arr_lidx)
 * 
 ...
 */
  ...
  __pyx_t_3 = __Pyx_PyObject_GetSlice(__pyx_v_arr_lidx, 0, __pyx_v_nfound, NULL, NULL, NULL, 0, 1, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 81, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_r = __pyx_t_3;
  __pyx_t_3 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("sorted_nearest.src.k_nearest_ties.get_all_ties", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_14sorted_nearest_3src_14k_nearest_ties_1get_all_ties(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_14sorted_nearest_3src_14k_nearest_ties_get_all_ties[] = "all fetches until you have k nearest intervals and then all intervals with same distance.";
static PyObject *__pyx_pw_14sorted_nearest_3src_14k_nearest_ties_1get_all_ties(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_lx = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_all_ties (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_lx,&__pyx_n_s_ids,&__pyx_n_s_dist,&__pyx_n_s_k,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_lx)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ids)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_all_ties", 1, 4, 4, 1); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_dist)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_all_ties", 1, 4, 4, 2); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_k)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_all_ties", 1, 4, 4, 3); __PYX_ERR(0, 11, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "get_all_ties") < 0)) __PYX_ERR(0, 11, __pyx_L3_error)
      }
    ...
    __pyx_v_lx = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_int64_t__const__(values[0], 0); if (unlikely(!__pyx_v_lx.memview)) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_ids = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_int64_t__const__(values[1], 0); if (unlikely(!__pyx_v_ids.memview)) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_dist = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_int64_t__const__(values[2], 0); if (unlikely(!__pyx_v_dist.memview)) __PYX_ERR(0, 11, __pyx_L3_error)
  ...
  __Pyx_RaiseArgtupleInvalid("get_all_ties", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 11, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("sorted_nearest.src.k_nearest_ties.get_all_ties", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_14sorted_nearest_3src_14k_nearest_ties_get_all_ties(__pyx_self, __pyx_v_lx, __pyx_v_ids, __pyx_v_dist, __pyx_v_k);
...
static PyObject *__pyx_pf_14sorted_nearest_3src_14k_nearest_ties_get_all_ties(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_lx, __Pyx_memviewslice __pyx_v_ids, __Pyx_memviewslice __pyx_v_dist, int __pyx_v_k) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __Pyx_RefNannySetupContext("get_all_ties", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_14sorted_nearest_3src_14k_nearest_ties_get_all_ties(__pyx_v_lx, __pyx_v_ids, __pyx_v_dist, __pyx_v_k, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_lx, 1);
...
/* "sorted_nearest/src/k_nearest_ties.pyx":87
 * @cython.wraparound(False)
 * @cython.initializedcheck(False)
...
static PyObject *__pyx_pw_14sorted_nearest_3src_14k_nearest_ties_3get_different_ties(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_14sorted_nearest_3src_14k_nearest_ties_get_different_ties(__Pyx_memviewslice __pyx_v_lx, __Pyx_memviewslice __pyx_v_ids, __Pyx_memviewslice __pyx_v_dist, int __pyx_v_k, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_first_i;
  int __pyx_v_current_found;
  int __pyx_v_nfound;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("get_different_ties", 0);

  /* "sorted_nearest/src/k_nearest_ties.pyx":99
 *     # then keep all with same distance
 *     cdef:
 *         int i = 0             # <<<<<<<<<<<<<<
 *         int first_i = 0
 ...
 */
  ...
  /* "sorted_nearest/src/k_nearest_ties.pyx":100
 *     cdef:
 *         int i = 0
 *         int first_i = 0             # <<<<<<<<<<<<<<
 *         int current_found = 0
 ...
 */
  ...
  /* "sorted_nearest/src/k_nearest_ties.pyx":101
 *         int i = 0
 *         int first_i = 0
 *         int current_found = 0             # <<<<<<<<<<<<<<
 *         int nfound = 0
 ...
 */
  ...
  /* "sorted_nearest/src/k_nearest_ties.pyx":102
 *         int first_i = 0
 *         int current_found = 0
 *         int nfound = 0             # <<<<<<<<<<<<<<
 *         int current_id = ids[0]
 ...
 */
  ...
  /* "sorted_nearest/src/k_nearest_ties.pyx":103
 *         int current_found = 0
 *         int nfound = 0
 *         int current_id = ids[0]             # <<<<<<<<<<<<<<
 *         int last_id = -1
 ...
 */
  ...
  /* "sorted_nearest/src/k_nearest_ties.pyx":104
 *         int nfound = 0
 *         int current_id = ids[0]
 *         int last_id = -1             # <<<<<<<<<<<<<<
 *         int length = len(lx)
 ...
 */
  ...
  /* "sorted_nearest/src/k_nearest_ties.pyx":105
 *         int current_id = ids[0]
 *         int last_id = -1
 *         int length = len(lx)             # <<<<<<<<<<<<<<
 *         int current_dist = -1
 ...
 */
  ...
  /* "sorted_nearest/src/k_nearest_ties.pyx":106
 *         int last_id = -1
 *         int length = len(lx)
 *         int current_dist = -1             # <<<<<<<<<<<<<<
 *         int last_dist = -1
 ...
 */
  ...
  /* "sorted_nearest/src/k_nearest_ties.pyx":107
 *         int length = len(lx)
 *         int current_dist = -1
 *         int last_dist = -1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sorted_nearest/src/k_nearest_ties.pyx":109
 *         int last_dist = -1
 * 
 *     arr_lidx = np.ones(length, dtype=np.long) * -1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_length); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 109, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_long); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 109, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_dtype, __pyx_t_7) < 0) __PYX_ERR(0, 109, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_7 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_5, __pyx_t_3); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 109, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyNumber_Multiply(__pyx_t_7, __pyx_int_neg_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 109, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_v_arr_lidx = __pyx_t_3;
  __pyx_t_3 = 0;

  /* "sorted_nearest/src/k_nearest_ties.pyx":113
 *     cdef long [::1] lidx
 * 
 *     lidx = arr_lidx             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_dc_long(__pyx_v_arr_lidx, PyBUF_WRITABLE); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 113, __pyx_L1_error)
  __pyx_v_lidx = __pyx_t_8;
  __pyx_t_8.memview = NULL;
  __pyx_t_8.data = NULL;

  /* "sorted_nearest/src/k_nearest_ties.pyx":120
 ...
 */
  while (1) {
    ...
    /* "sorted_nearest/src/k_nearest_ties.pyx":128
 *         # print("nfound", nfound)
 *         # print("length", length)
 *         first_i = i             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "sorted_nearest/src/k_nearest_ties.pyx":130
 *         first_i = i
 * 
 *         if ids[i] != last_id:             # <<<<<<<<<<<<<<
 *             # we have come to a new id, need to start counting again
 ...
 */
    ...
    if (__pyx_t_9) {
      ...
      /* "sorted_nearest/src/k_nearest_ties.pyx":134
 * 
 * 
 *             current_found = 0             # <<<<<<<<<<<<<<
 *             current_id = ids[i]
 ...
 */
      ...
      /* "sorted_nearest/src/k_nearest_ties.pyx":135
 * 
 *             current_found = 0
 *             current_id = ids[i]             # <<<<<<<<<<<<<<
 *             last_id = ids[i]
 ...
 */
      ...
      /* "sorted_nearest/src/k_nearest_ties.pyx":136
 *             current_found = 0
 *             current_id = ids[i]
 *             last_id = ids[i]             # <<<<<<<<<<<<<<
 *             continue
 ...
 */
      ...
      /* "sorted_nearest/src/k_nearest_ties.pyx":137
 *             current_id = ids[i]
 *             last_id = ids[i]
 *             continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "sorted_nearest/src/k_nearest_ties.pyx":140
 * 
 *         # while have not found k different ties, continue
 *         while i < length and ids[i] == last_id and current_found < k:             # <<<<<<<<<<<<<<
 *             # print("**first while**")
 ...
 */
    while (1) {
      ...
      /* "sorted_nearest/src/k_nearest_ties.pyx":143
 *             # print("**first while**")
 *             # print("i", i, "length", length, "ids[i]", ids[i], "last_id", last_id, "dist[i]", last_dist, "current_found", current_found)
 *             lidx[nfound] = lx[i]             # <<<<<<<<<<<<<<
 *             # print("lidx", arr_lidx)
 ...
 */
      ...
      *((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_lidx.data) + __pyx_t_11)) )) = (*((int64_t const  *) ( /* dim=0 */ ((char *) (((int64_t const  *) __pyx_v_lx.data) + __pyx_t_1)) )));
      ...
      /* "sorted_nearest/src/k_nearest_ties.pyx":145
 *             lidx[nfound] = lx[i]
 *             # print("lidx", arr_lidx)
 *             last_dist = dist[i]             # <<<<<<<<<<<<<<
 *             nfound += 1
 ...
 */
      ...
      /* "sorted_nearest/src/k_nearest_ties.pyx":146
 *             # print("lidx", arr_lidx)
 *             last_dist = dist[i]
 *             nfound += 1             # <<<<<<<<<<<<<<
 *             i += 1
 ...
 */
      ...
      /* "sorted_nearest/src/k_nearest_ties.pyx":147
 *             last_dist = dist[i]
 *             nfound += 1
 *             i += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "sorted_nearest/src/k_nearest_ties.pyx":149
 *             i += 1
 * 
 *             if i < length and dist[i] != last_dist:             # <<<<<<<<<<<<<<
 *                 current_found += 1
 ...
 */
      ...
      if (__pyx_t_9) {
        ...
        /* "sorted_nearest/src/k_nearest_ties.pyx":150
 * 
 *             if i < length and dist[i] != last_dist:
 *                 current_found += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "sorted_nearest/src/k_nearest_ties.pyx":153
 * 
 *         # while we have not found all ties with same length as last included
 *         while i < length and ids[i] == last_id and dist[i] == last_dist:             # <<<<<<<<<<<<<<
 *             # print("**second while**")
 ...
 */
    while (1) {
      ...
      /* "sorted_nearest/src/k_nearest_ties.pyx":156
 *             # print("**second while**")
 *             # print("i", i, "length", length, "ids[i]", ids[i], "last_id", last_id, "dist[i]", last_dist, "current_found", current_found)
 *             lidx[nfound] = lx[i]             # <<<<<<<<<<<<<<
 *             # print("lidx", arr_lidx)
 ...
 */
      ...
      *((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_lidx.data) + __pyx_t_11)) )) = (*((int64_t const  *) ( /* dim=0 */ ((char *) (((int64_t const  *) __pyx_v_lx.data) + __pyx_t_1)) )));
      ...
      /* "sorted_nearest/src/k_nearest_ties.pyx":158
 *             lidx[nfound] = lx[i]
 *             # print("lidx", arr_lidx)
 *             nfound += 1             # <<<<<<<<<<<<<<
 *             i += 1
 ...
 */
      ...
      /* "sorted_nearest/src/k_nearest_ties.pyx":159
 *             # print("lidx", arr_lidx)
 *             nfound += 1
 *             i += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "sorted_nearest/src/k_nearest_ties.pyx":161
 *             i += 1
 * 
 *         if i == first_i:             # <<<<<<<<<<<<<<
 *             i += 1
 ...
 */
    ...
    if (__pyx_t_9) {
      ...
      /* "sorted_nearest/src/k_nearest_ties.pyx":162
 * 
 *         if i == first_i:
 *             i += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sorted_nearest/src/k_nearest_ties.pyx":166
 *         # print(arr_lidx)
 * 
 *     return arr_lidx[:nfound]             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_3 = __Pyx_PyObject_GetSlice(__pyx_v_arr_lidx, 0, __pyx_v_nfound, NULL, NULL, NULL, 0, 1, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 166, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_r = __pyx_t_3;
  __pyx_t_3 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_7);
  __PYX_XDEC_MEMVIEW(&__pyx_t_8, 1);
  __Pyx_AddTraceback("sorted_nearest.src.k_nearest_ties.get_different_ties", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_arr_lidx);
  __PYX_XDEC_MEMVIEW(&__pyx_v_lidx, 1);
...
/* Python wrapper */
static PyObject *__pyx_pw_14sorted_nearest_3src_14k_nearest_ties_3get_different_ties(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_14sorted_nearest_3src_14k_nearest_ties_2get_different_ties[] = "fetch all ties until you have all intervals with k distances";
static PyObject *__pyx_pw_14sorted_nearest_3src_14k_nearest_ties_3get_different_ties(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_lx = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_ids = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_dist = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_k;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_different_ties (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_lx,&__pyx_n_s_ids,&__pyx_n_s_dist,&__pyx_n_s_k,0};
    PyObject* values[4] = {0,0,0,0};
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ids)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("get_different_ties", 1, 4, 4, 1); __PYX_ERR(0, 87, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_dist)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_different_ties", 1, 4, 4, 2); __PYX_ERR(0, 87, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_k)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_different_ties", 1, 4, 4, 3); __PYX_ERR(0, 87, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "get_different_ties") < 0)) __PYX_ERR(0, 87, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 4) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_lx = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_int64_t__const__(values[0], 0); if (unlikely(!__pyx_v_lx.memview)) __PYX_ERR(0, 87, __pyx_L3_error)
    __pyx_v_ids = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_int64_t__const__(values[1], 0); if (unlikely(!__pyx_v_ids.memview)) __PYX_ERR(0, 87, __pyx_L3_error)
    __pyx_v_dist = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_int64_t__const__(values[2], 0); if (unlikely(!__pyx_v_dist.memview)) __PYX_ERR(0, 87, __pyx_L3_error)
    __pyx_v_k = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_k == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 87, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("get_different_ties", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 87, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("sorted_nearest.src.k_nearest_ties.get_different_ties", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_14sorted_nearest_3src_14k_nearest_ties_2get_different_ties(__pyx_self, __pyx_v_lx, __pyx_v_ids, __pyx_v_dist, __pyx_v_k);
...
static PyObject *__pyx_pf_14sorted_nearest_3src_14k_nearest_ties_2get_different_ties(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_lx, __Pyx_memviewslice __pyx_v_ids, __Pyx_memviewslice __pyx_v_dist, int __pyx_v_k) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("get_different_ties", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_14sorted_nearest_3src_14k_nearest_ties_get_different_ties(__pyx_v_lx, __pyx_v_ids, __pyx_v_dist, __pyx_v_k, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 87, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "sorted_nearest.src.k_nearest_ties.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "sorted_nearest.src.k_nearest_ties.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "sorted_nearest.src.k_nearest_ties.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "sorted_nearest.src.k_nearest_ties._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"get_all_ties", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_14sorted_nearest_3src_14k_nearest_ties_1get_all_ties, METH_VARARGS|METH_KEYWORDS, __pyx_doc_14sorted_nearest_3src_14k_nearest_ties_get_all_ties},
  {"get_different_ties", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_14sorted_nearest_3src_14k_nearest_ties_3get_different_ties, METH_VARARGS|METH_KEYWORDS, __pyx_doc_14sorted_nearest_3src_14k_nearest_ties_2get_different_ties},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_k_nearest_ties(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_k_nearest_ties},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initk_nearest_ties(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initk_nearest_ties(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_k_nearest_ties(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_k_nearest_ties(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_k_nearest_ties(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'k_nearest_ties' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_k_nearest_ties(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("k_nearest_ties", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_sorted_nearest__src__k_nearest_ties) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "sorted_nearest.src.k_nearest_ties")) {
      if (unlikely(PyDict_SetItemString(modules, "sorted_nearest.src.k_nearest_ties", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "sorted_nearest/src/k_nearest_ties.pyx":5
 * cimport cython
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sorted_nearest/src/k_nearest_ties.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init sorted_nearest.src.k_nearest_ties", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init sorted_nearest.src.k_nearest_ties");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
